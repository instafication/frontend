...
<div id="readmore" class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center lg:max-w-4xl">
    ...
    <p class="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">{$t("pricing_modal_title2")}</p>
  </div>
  <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">{$t("pricing_modal_body")}</p>
