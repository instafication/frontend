...
<div class="flex gap-4">
    ...
    <Button class="border-0" color="alternative" id="trigger-button">
  ...
  <Dropdown triggeredBy="#trigger-button" class="transition duration-150 ease-in-out">
    ...
    <DropdownItem on:click={() => $selectedLanguage = "en"} class="flex items-center transition duration-150 ease-in-out">
      <Us size=32 class="px-2"/>
       English
    </DropdownItem>
